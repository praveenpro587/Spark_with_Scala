...
object BroadcastMoviesDS {
  ...
  val moviesRDD=Source.fromFile("C:/Users/prave/OneDrive/Desktop/Trendy Tech/Spark-Week3/movies.dat").getLines().map(x=>(x.split("::")(0),x.split("::")(1)))
  ...
  /*val JoinedRDD=ratingsProcessed.join(braodcast)
